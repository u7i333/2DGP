...
#points=[(-350,-100),(-50,200),(150,-100)]
#points2=[(-50,200),(150,-100),(350,300)]
#p=1
#draw_curve_3_points(points[p-1],points[p],points[p+1])
#draw_curve_3_points(points2[p-1],points2[p],points2[p+1])
